...
#pragma endregion
		...
		private: System::Void meanFilteringToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
			...
			Interaction::InputBox("Not: ﬁablon boyutu, en az 3 olacak ˛ekilde tek say˝lardan olu˛ur. Boyut b¸y¸kd¸kÁe yumu˛atma artar.\nﬁablon boyutu : ", "ﬁablon Boyutu", "3", 500, 500);
